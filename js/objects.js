...
//     console.log(person.lastName)
    ...
    //         console.log("Congrats " + shopper.name + " ! You have spent over $200! Your current total is $" + shopper.amount + " . You now get a 12% discount. Your new discounted total is: " + (shopper.amount - (shopper.amount * .12)) + " ." )
    //     } else {
